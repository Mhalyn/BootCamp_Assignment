...
<head>
    ...
    <link href="vendor/datepicker/sign_up_daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="css/sign_up.css" rel="stylesheet" media="all">
</head>
...
<body>
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="adult">
                                            <option disabled="disabled" selected="selected">0</option>
                                            <option>Male</option>
    ...
    <script src="vendor/datepicker/sign_up_moment.min.js"></script>
    <script src="vendor/datepicker/sign_up_daterangepicker.js"></script>
